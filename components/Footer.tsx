...
type SingleFooterListItem = { title: string; href: string ; newTab?: boolean };
...
const footerItems: FooterItems = [
  ...
  // },
  {
    title: 'Product',
    items: [
      { title: 'Course Details', href: '/courseDetails' },
      { title: 'Pricing', href: '/pricing' },
      { title: 'Apply Now', href: 'https://forms.gle/SQ1cYj7L1DpHcK6L6', newTab: true },
    ...
    <FooterWrapper>
      <Container>
        ...
        <BottomBar>
          ...
          <Copyright>&copy; Copyright 2022 CodingQuest</Copyright>
        </BottomBar>
      </Container>
    </FooterWrapper>
  );
...
function ListItem({ title, href, newTab }: SingleFooterListItem) {
  if(newTab) {
    return (
      <ListItemWrapper>
